...
const envPath: string = path.join(projectRoot, 'client/.env');
...
console.log('  5. Copy ALL content from: supabase/migrations/schema.sql');
...
console.log('  2. Copy ALL content from: supabase/seed/complete_seed.sql');
